# Environment Variables Module - Bash Compatible
# Configuration for various tools and applications

# Skip .profile in bash mode - it often contains zsh-specific syntax
# If needed, create a separate .bash_profile for bash-specific login configuration
# [[ -f "$HOME/.profile" ]] && source "$HOME/.profile"

# Only load utilities if explicitly requested (for performance)
# Use: LOAD_DOTFILES_UTILS=1 bash to enable
